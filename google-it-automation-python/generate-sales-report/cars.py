...
def process_data(data):
  ...
  for item in data:
    ...
    if item["total_sales"] > max_sales_value:
      
      max_sales_value = item["total_sales"]
      max_sales_item = item
  ...
  summary = [
    ...
    "The {} had the most sales: {}".format(format_car(max_sales_item["car"]), max_sales_value), 
    "The most popular year was {} with {} sales.".format(max_year, years[max_year])
 ]
